...
//
//             if (timerHitShowMap[playerUuid]) {
//                 event.server.getScheduledEvents().clear(timerHitShowMap[playerUuid])
//                 timerHitShowMap[playerUuid] = undefined
//             }
//
...
//             })
//
//             timerHitShowMap[playerUuid] = event.server.scheduleInTicks(100, () => {
//                 fnRemove()
//             }).id
//         } else {
//             fnRemove()
